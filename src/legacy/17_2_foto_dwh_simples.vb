 Sub Bases_NR()
    ...
    Base_Simple_x_Taxo db_bases_simples, db_foto_simples_cohortes_vf, "where (A.[TAXONOMIA]='GARANTIA MICROCREDITO')", tbl_vf_foto_nr, "Microcredito"
    Base_Simple_x_Taxo db_bases_simples, db_foto_simples_cohortes_vf, "where (A.[TAXONOMIA]<>'GARANTIA EMPRESARIAL' and A.[TAXONOMIA]<>'GARANTIA MICROCREDITO')", tbl_vf_foto_nr, "Resto"
    Base_Simple_x_Taxo db_bases_simples, db_foto_simples_cohortes_vf, "where (A.[TAXONOMIA]='GARANTIA EMPRESARIAL')", tbl_vf_foto_nr, "Empresarial",
...
Function Base_Simple_x_Taxo(db_bases_simples, db_foto_simples_cohortes_vf, Filtro, Foto, TaxoBase)
