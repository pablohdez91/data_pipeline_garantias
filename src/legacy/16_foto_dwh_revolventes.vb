Sub Bases_R()
    ...
    Agrupa_x_Taxo db_bases_revolventes, db_foto_revolventes_cohortes_preliminar, Linea, "where (A.[TAXONOMIA]='GARANTIA MICROCREDITO')", tbl_vf_foto_r, "Microcredito", fecha_base
    Agrupa_x_Taxo db_bases_revolventes, db_foto_revolventes_cohortes_preliminar, Linea, "where (A.[TAXONOMIA]<>'GARANTIA EMPRESARIAL' and A.[TAXONOMIA]<>'EMPRESA MEDIANA' and A.[TAXONOMIA]<>'GARANTIA MICROCREDITO')", tbl_vf_foto_r, "Resto", fecha_base
    Agrupa_x_Taxo db_bases_revolventes, db_foto_revolventes_cohortes_preliminar, Linea, "where (A.[TAXONOMIA]='GARANTIA EMPRESARIAL' or A.[TAXONOMIA]='EMPRESA MEDIANA')", tbl_vf_foto_r, "Empresarial", fecha_base
    Genera_x_Taxo db_bases_revolventes, db_foto_revolventes_cohortes_preliminar, Linea, "where (A.[TAXONOMIA]='GARANTIA EMPRESARIAL')", tbl_vf_foto_r, "Empresarial_x_Disposicion", fecha_base
...
Function Agrupa_x_Taxo(db_bases_revolventes, db_foto_revolventes_cohortes_preliminar, Linea, Filtro, tbl_vf_foto_r, TaxoBase, fecha_base As Date)
    Dim dbs As database
    ...
    dbs.Close
End Function
Function Genera_x_Taxo(db_bases_revolventes, db_foto_revolventes_cohortes_preliminar, Linea, Filtro, tbl_vf_foto_r, TaxoBase, fecha_base As Date)
    Dim dbs As database
    Set dbs = OpenDatabase(db_bases_revolventes)
    dbs.Execute "SELECT " & Linea & ", " _
